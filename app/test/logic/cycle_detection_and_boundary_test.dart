...
void main() {
  ...
  group('Automatic Cycle Detection & Boundary Operations', () {
    ...
    group('1. Auto detection (H/M menses >= 16 days starts new cycle)', () {
      test('heavy or moderate bleeding >= 16 days from cycle start creates new cycle', () async {
    ...
    group('2. Pre-menstrual rollback', () {
      test('L/VL bleeding on day 16 leading into H/M flow on day 17 backdates cycle start date to day 16', () async {
        final cycle1Start = DateTime(2026, 6, 1);
        await db.saveObservation(
          date: cycle1Start,
          sensation: Sensation.dry,
      ...
      test('multiple contiguous L/VL days >= 16 days backdates to earliest contiguous L/VL day', () async {
        final cycle1Start = DateTime(2026, 6, 1);
        await db.saveObservation(
          date: cycle1Start,
          sensation: Sensation.dry,
    ...
    group('3. Mid-cycle bleeding protection', () {
      test('bleeding < 16 days from cycle start does NOT start a new cycle', () async {
        final cycle1Start = DateTime(2026, 6, 1);
        await db.saveObservation(
          date: cycle1Start,
          sensation: Sensation.dry,
    ...
    group('4. startNewCycle manual splitting', () {
      test('manually starting a cycle splits existing cycle entries cleanly at the new boundary', () async {
        final cycle1Start = DateTime(2026, 6, 1);
        await db.saveObservation(
          date: cycle1Start,
          sensation: Sensation.dry,
