          ...
          OptionGrid(
            ...
            children: [
              OptionCard(
                ...
                isSelected: bleedingColor == 'R',
                onTap: () => onSelectColor?.call('R'),
              ),
              OptionCard(
                label: 'Brown (B)',
                icon: Icons.color_lens_outlined,
                subtitle: 'Brownish discharge',
                isSelected: bleedingColor == 'B',
                onTap: () => onSelectColor?.call('B'),
              ),
              OptionCard(
                label: 'Black (K)',
                icon: Icons.circle,
                subtitle: 'Blackish old blood',
                isSelected: bleedingColor == 'K',
                onTap: () => onSelectColor?.call('K'),
              ),
            ],
          ),
        ],
